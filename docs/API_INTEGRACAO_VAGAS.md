...
> **Para testes:**  
> Você pode testar com a empresa `gjhghjgjhg`, cujo ID é: `80ba964d-37ec-4e68-ad49-b2d25ea71eae`.
...
Após você construir todo o layout da vaga com o JSON que nós demos mastigado usando o link 2 acima, você vai botar o link do "Inscreva-se Agora/Candidatar-se" lá em baixo no formulário. A URL de redirecionamento deste botão deve apontar de volta para as origens do software principal: 

`https://url-do-seu-sistema.com/#/v/{public_hash}` ou `https://url-do-seu-sistema.com/#/v/{public_hash}/candidatar`

A partir do momento que o cara cai nesta plataforma nativa pelo link, nós ficamos 100% encarregados da captura e cálculo da inteligência artificial para o RH. Você apenas serviu de Vitrine atraente e com tráfego!
