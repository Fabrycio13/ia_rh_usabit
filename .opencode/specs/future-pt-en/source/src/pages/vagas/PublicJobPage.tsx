        ...
        return (
            <div style={{ minHeight: '100vh', background: '#0B1020', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '14px' }}>{t('carregandoVaga')}</p>
                </div>
            </div>
        );
    }
            ...
            <div style={{ 
                ...
                <div style={{ flex: 1 }}>
                    <p style={{ 
                        ...
                        {job.company_name && job.show_company_name !== false ? job.company_name : t('vagasAbertasPortal')}
                    </p>
                    <h1 style={{ 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                    ...
                    <p style={{ 
                        ...
                        {t('vagaPublicadaEm')} {formatDate(job.created_at)}
                    </p>
                </div>
            </div>
                ...
                <div style={{ maxWidth: '900px' }}>
                    {job.description && (
                        <div className="job-content-section">
                            <h2 className="section-title">{t('sobreVaga')}</h2>
                    ...
                    {job.responsibilities && (
                        <div className="job-content-section">
                            <h2 className="section-title">{t('responsabilidades')}</h2>
                            <div className="rich-text-content">
                                <ul>
                    ...
                    {job.requirements && (
                        <div className="job-content-section">
                            <h2 className="section-title">{t('requisitos')}</h2>
                            <div className="rich-text-content">
                                <ul>
                    ...
                    {job.differentials && (
                        <div className="job-content-section">
                            <h2 className="section-title">{t('diferenciais')}</h2>
                            <div className="rich-text-content">
                                <ul>
                    ...
                    {job.additional_info && (
                        <div className="job-content-section">
                            <h2 className="section-title">{t('informacoesAdicionais')}</h2>
                            <div className="rich-text-content">
                                <ul>
