        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const { data: candData, error: candError } = await supabase
                    ...
                    .select('id, candidate_name, candidate_email, candidate_phone, candidate_location, candidate_linkedin, resume_url, resume_file_name, applied_at, status, match_score, candidate_gender, candidate_age, answers, internal_notes, ai_analysis')
                    .eq('vaga_id', id)
                                ...
                                return (
                                    <div key={candidato.id} style={{ borderBottom: '1px solid var(--border)' }}>
                                        ...
                                        >
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                <button title="Mover para Banco de Talentos" onClick={(e) => { e.stopPropagation(); setTransferringCand(candidato); }} style={{ width: 34, height: 34, padding: '0', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid #10b981', borderRadius: '8px', color: '#10b981', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' }}
