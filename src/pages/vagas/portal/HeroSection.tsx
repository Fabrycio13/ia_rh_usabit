  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, maxWidth: 640 }}>
        ...
        >
          {`Comece sua melhor jornada com a ${orgName}`}
        </h1>
        <p
          style={{
        ...
        >
          Valorizamos a autonomia, o bem-estar e o crescimento. Investimos em
          pessoas e em tecnologia para transformar realidades e deixar um legado
          de impacto.
        </p>
