...
export const LandingPage = () => {
  ...
  const howItWorks = [
    { step: '01', icon: FileText, title: t('comoFuncionaStep1Titulo'), desc: t('comoFuncionaStep1Desc') },
    { step: '02', icon: Inbox, title: t('comoFuncionaStep2Titulo'), desc: t('comoFuncionaStep2Desc') },
    { step: '03', icon: Handshake, title: t('comoFuncionaStep3Titulo'), desc: t('comoFuncionaStep3Desc') },
  ];

  const features = [
    { title: t('feature1Titulo'), desc: t('feature1Desc') },
    { title: t('feature2Titulo'), desc: t('feature2Desc') },
    { title: t('feature3Titulo'), desc: t('feature3Desc') },
    { title: t('feature4Titulo'), desc: t('feature4Desc') },
    { title: t('feature5Titulo'), desc: t('feature5Desc') },
    { title: t('feature6Titulo'), desc: t('feature6Desc') },
    { title: t('feature7Titulo'), desc: t('feature7Desc') },
    { title: t('feature8Titulo'), desc: t('feature8Desc') },
  ];
    ...
    <>
      ...
      <div className="lp-root">
        ...
        <nav className="lp-nav">
          <button className="lp-logo" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} aria-label={t('voltarAoTopo')}>
            <UsabitPeopleLogo height={26} />
          </button>

          <div className="lp-nav-links">
            <button className="lp-nav-link" onClick={() => scrollTo('como-funciona')}>{t('comoFuncionaLink')}</button>
            <button className="lp-nav-link" onClick={() => scrollTo('funcionalidades')}>{t('funcionalidadesLink')}</button>
            <button className="lp-nav-link" onClick={() => scrollTo('depoimentos')}>{t('depoimentosLink')}</button>
          </div>
          ...
          <div className="lp-hero-card">
            <div className="lp-hero-left">
              <h1 className="lp-title">
                {t('recrutamentoColaborativo')}<br />
                <span className="lp-title-accent">{t('recrutamentoIA')}</span>
              </h1>
              <p className="lp-sub">
                {t('heroSubtitle')}
              </p>
              <div className="lp-hero-btns">
                <button className="btn-hero-primary" onClick={() => navigate('/registro')}>
                  <span>{t('comeceTestarGratis')}</span>
                  <span className="animation"></span>
                </button>
              </div>
            </div>
        ...
        <div style={{ background: 'rgba(59,130,246,0.03)', borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', position: 'relative', zIndex: 1 }}>
          <section id="como-funciona" className="lp-section">
            <div className="lp-section-tag">{t('comoFuncionaTag')}</div>
            <h2 className="lp-section-title">{t('comoFuncionaTitulo').split(',')[0]}, <span className="lp-title-accent">{t('comoFuncionaTitulo').split(',').slice(1).join(',')}</span></h2>
            <p className="lp-section-sub">{t('comoFuncionaDesc')}</p>
        ...
        <section id="funcionalidades" className="lp-section">
          <h2 className="lp-section-title">{t('funcionalidadesTitulo').split(t('contratarMelhorPlataforma'))[0]}<span className="lp-title-accent">{t('contratarMelhorPlataforma')}</span></h2>
          <p className="lp-section-sub">{t('funcionalidadesDesc')}</p>
        ...
        <div id="depoimentos-section">
          <section id="depoimentos" className="lp-section" style={{ padding: '0', maxWidth: '1200px', margin: '0 auto' }}>
            <h2 className="lp-section-title">
              {t('depoimentosTitulo').split(t('recrutamentoIA'))[0]}<span className="lp-title-accent">{t('recrutamentoIA')}</span>
            </h2>
        ...
        <section className="lp-cta">
          <div className="lp-cta-inner">
            <h2 className="lp-cta-title">
              {t('ctaFinalTitulo')}{' '}
              <span className="lp-title-accent">{t('ctaFinalRecrutar')}</span>
            </h2>
            ...
            <div className="lp-cta-metrics">
              <div className="lp-metric-card">
                <div className="hover_color_bubble"></div>
                <div className="lp-metric-value">{t('ctaPersonalizado')}</div>
                <div className="lp-metric-label">{t('ctaPersonalizadoDesc')}</div>
              </div>
              <div className="lp-metric-card">
                <div className="hover_color_bubble"></div>
                <div className="lp-metric-value">{t('ctaColaborativo')}</div>
                <div className="lp-metric-label">{t('ctaColaborativoDesc')}</div>
              </div>
              <div className="lp-metric-card">
                <div className="hover_color_bubble"></div>
                <div className="lp-metric-value">{t('ctaRLS')}</div>
                <div className="lp-metric-label">{t('ctaRLSDesc')}</div>
              </div>
            </div>
            ...
            <div className="lp-cta-btn-wrap">
              ...
              >
                <span>{t('falarEspecialista')}</span>
                <span className="animation"></span>
              </a>
            </div>
            <p className="lp-cta-hint">{t('semCompromisso')}</p>
          </div>
          ...
          <div className="lp-footer-inner">
            ...
            <div className="lp-footer-top">
              <div className="lp-footer-brand">
                ...
                <p className="lp-footer-tagline">{t('footerTaglineLp')}</p>
              </div>
            ...
            <div className="lp-footer-bottom">
              <p className="lp-footer-copy">{t('copyrightLp')}</p>
              <p className="lp-footer-powered">{t('poweredByUsabit')} <strong>Usabit people</strong></p>
            </div>
          </div>
        </footer>
      </div>
